...
execute in tide:ocean positioned as @e[type=minecraft:marker,tag=tide.worldgen.structure.cursor,limit=1] store result score #dispatch tide.worldgen.map.tmp run function tide:worldgen/map/structure/build/dispatch
execute in tide:ocean run kill @e[type=minecraft:marker,tag=tide.worldgen.structure.cursor]
