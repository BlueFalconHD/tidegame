...
execute if score @s tide.worldgen.map.attempt matches 129.. run function tide:worldgen/map/layout/candidate/fail
execute if score @s tide.worldgen.map.attempt matches 129.. run return fail

execute store result score @s tide.worldgen.map.pos.x run random value -360..359
execute store result score @s tide.worldgen.map.pos.z run random value -360..359
