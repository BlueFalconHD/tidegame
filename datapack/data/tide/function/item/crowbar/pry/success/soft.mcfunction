...
execute if score #broken_class tide.salvage.tmp matches 0 run scoreboard players set #broken_class tide.salvage.tmp 1

particle minecraft:poof ~0.5 ~0.5 ~0.5 0.2 0.2 0.2 0.03 3 normal
