...
execute if score #broken_class tide.salvage.tmp matches ..1 run scoreboard players set #broken_class tide.salvage.tmp 2

particle minecraft:scrape ~0.5 ~0.5 ~0.5 0.2 0.2 0.2 0.03 4 normal
