...
execute unless score #local_x tide.raft.tmp matches 0.. run return run function tide:item/raft/internal/reject/outside
execute unless score #local_z tide.raft.tmp matches 0.. run return run function tide:item/raft/internal/reject/outside
...
execute unless score #local_x tide.raft.tmp matches 0..127 run return run function tide:item/raft/internal/reject/outside
execute unless score #local_z tide.raft.tmp matches 0..127 run return run function tide:item/raft/internal/reject/outside
...
execute unless score #island_found tide.raft.tmp matches 1 run return run function tide:item/raft/internal/reject/outside
execute unless score #placer_island tide.identifier.island = #raft_island tide.identifier.island run return run function tide:item/raft/internal/reject/not_member
...
execute unless score #raft_available tide.raft.tmp matches 1 run return run function tide:item/raft/internal/reject/duplicate
...
execute as @e[type=minecraft:marker,tag=tide.island.registry] if score @s tide.identifier.island = #raft_island tide.identifier.island run function tide:item/raft/internal/register_island
...
execute store result score #interaction_created tide.raft.tmp run function tide:item/raft/internal/create_interaction
execute unless score #interaction_created tide.raft.tmp matches 1 as @e[type=minecraft:marker,tag=tide.island.registry] if score @s tide.identifier.island = #raft_island tide.identifier.island run function tide:item/raft/internal/unregister_island
execute unless score #interaction_created tide.raft.tmp matches 1 run return run function tide:item/raft/internal/reject/interaction
