...
execute as @e[type=minecraft:bamboo_raft,tag=tide.raft,tag=!tide.raft.registered,distance=..6,sort=nearest,limit=1] at @s run function tide:item/raft/internal/register
