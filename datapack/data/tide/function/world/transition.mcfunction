...
scoreboard players set @a[tag=!tide.ocean.returning,tag=!tide.ocean.return.pending,tag=!tide.ocean.return.settling] tide.area_transition 0
...
scoreboard players remove @a[tag=tide.ocean.return.settling,scores={tide.area_transition=1..}] tide.area_transition 1
execute as @a[tag=tide.ocean.return.settling,scores={tide.area_transition=..0}] at @s run function tide:world/ocean/return_home/finish_arrival
