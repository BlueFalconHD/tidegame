...
function tide:world/gen/queue/acquire/query with storage tide:worldgen scratch
execute unless score #acquire_ok tide.wgen matches 1 run return fail
...
execute unless score #row_end tide.wgen matches 1 run return run function tide:world/gen/queue/acquire/step

scoreboard players operation #scan_x tide.wgen = #scan_min_x tide.wgen
scoreboard players add #scan_z tide.wgen 1
execute if score #scan_z tide.wgen <= #scan_max_z tide.wgen run return run function tide:world/gen/queue/acquire/step
return 1
