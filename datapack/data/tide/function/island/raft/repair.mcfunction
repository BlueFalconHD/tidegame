...
execute unless entity @s[tag=tide.island.has_island] run tellraw @s {"text":"You do not have an island to repair.","color":"red"}
...
execute unless score #repair_prepared tide.raft.tmp matches 1 run tellraw @s {"text":"This island has no deployed raft state to repair.","color":"yellow"}
...
execute unless score #repair_enqueued tide.raft.tmp matches 1 run tellraw @s {"text":"Unable to queue the raft repair.","color":"red"}
execute unless score #repair_enqueued tide.raft.tmp matches 1 run return fail

tellraw @s {"text":"Checking raft...","color":"aqua"}
return 1
