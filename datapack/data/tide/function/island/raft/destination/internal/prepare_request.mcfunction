data modify storage tide:chunkload request set value {dimension:"minecraft:overworld",callback:"tide:island/raft/destination/ready",x:0,y:0,z:0,min_x:0,min_z:0,max_x:0,max_z:0,traveler:0,island:0}
