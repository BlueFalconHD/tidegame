...
data modify storage tide:raft scratch.profile set value {has_island:0b}
...
execute if score #travel_candidate tide.identifier.island = #travel_destination tide.identifier.island run scoreboard players set #travel_friend_valid tide.raft.tmp 1
