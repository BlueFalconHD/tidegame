...
execute if score #social_source tide.social.tmp = #social_target tide.social.tmp run tellraw @s {"text":"You cannot add yourself as a friend.","color":"#D94286"}
...
execute unless score #social_target_online tide.social.tmp matches 1 run tellraw @s {"text":"That player is not online.","color":"#D94286"}
...
execute if score #social_friend_exists tide.social.tmp matches 1 run tellraw @s {"text":"You are already friends.","color":"#D94286"}
...
execute if score #social_request_exists tide.social.tmp matches 1 run tellraw @s {"text":"You already sent that player a friend request.","color":"#D94286"}
...
tellraw @s {"text":"Friend request sent.","color":"#E0CA8E"}
return 1
