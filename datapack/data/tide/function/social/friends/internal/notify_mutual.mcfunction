...
tellraw @s [{"text":"You are now friends with ","color":"gray"},{"selector":"@a[tag=tide.social.target,limit=1]","color":"aqua"},{"text":".","color":"gray"}]
tellraw @a[tag=tide.social.target,limit=1] [{"text":"You are now friends with ","color":"gray"},{"selector":"@a[tag=tide.social.actor,limit=1]","color":"aqua"},{"text":".","color":"gray"}]
