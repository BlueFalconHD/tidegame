...
execute as @a if score @s tide.identifier.player = #social_source tide.social.tmp run tellraw @s [{"selector":"@a[tag=tide.social.actor,limit=1]","color":"aqua"},{"text":" declined your friend request.","color":"gray"}]
