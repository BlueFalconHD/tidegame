$data modify storage tide:social ui.dialog.body append value {type:"minecraft:plain_message",contents:{text:"Remove $(name) from your friends?",color:"gray"},width:260}
