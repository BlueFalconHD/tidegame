...
data modify storage tide:social ui.dialog set value {type:"minecraft:confirmation",title:{text:"Remove Friend",color:"#D94286"},body:[],can_close_with_escape:true,pause:false,after_action:"close",yes:{label:{text:"Remove",color:"#D94286"},width:130},no:{label:{text:"Cancel",color:"gray"},width:130}}
