...
data modify storage tide:social ui.dialog set value {type:"minecraft:confirmation",title:{text:"Remove Friend",color:"red"},body:[],can_close_with_escape:true,pause:false,after_action:"close",yes:{label:{text:"Remove",color:"red"},width:130},no:{label:{text:"Cancel"},width:130}}
