...
data modify storage tide:social ui.dialog set value {type:"minecraft:multi_action",title:{text:"Add Friend",color:"green"},body:[{type:"minecraft:plain_message",contents:{text:"Choose an online player.",color:"gray"},width:260}],can_close_with_escape:true,pause:false,after_action:"close",actions:[],columns:1,exit_action:{label:{text:"Back"},width:150,action:{type:"run_command",command:"trigger tide.social.menu set 4"}}}
