...
function tide:social/friends/ui/home/count_friend with storage tide:social scratch.current
return run function tide:social/friends/ui/home/count_friends_next
