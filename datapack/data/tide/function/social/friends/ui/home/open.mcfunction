...
data modify storage tide:social ui.dialog set value {type:"minecraft:multi_action",title:{text:"Friends",color:"aqua"},body:[{type:"minecraft:plain_message",contents:{text:"Manage friends and friend requests.",color:"gray"},width:240}],can_close_with_escape:true,pause:false,after_action:"close",actions:[],columns:1,exit_action:{label:{text:"Close"},width:150}}
