...
data modify storage tide:social ui.dialog set value {type:"minecraft:multi_action",title:{text:"Friend Requests",color:"#F79317"},body:[{type:"minecraft:plain_message",contents:{text:"Incoming and sent friend requests.",color:"gray"},width:260}],can_close_with_escape:true,pause:false,after_action:"close",actions:[],columns:1,exit_action:{label:{text:"Back",color:"gray"},width:150,action:{type:"run_command",command:"trigger tide.social.menu set 4"}}}
