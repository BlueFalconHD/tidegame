...
data modify storage tide:social ui.dialog set value {type:"minecraft:multi_action",title:{text:"Friend Request",color:"#F2F2F2"},body:[],can_close_with_escape:true,pause:false,after_action:"close",actions:[],columns:2,exit_action:{label:{text:"Back",color:"#F2F2F2"},width:150,action:{type:"run_command",command:"trigger tide.social.menu set 2"}}}
